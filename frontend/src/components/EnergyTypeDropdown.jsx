...
import { ENERGY_TYPE_FILTER_OPTIONS } from "../constants/energyTypeOptions";
...
export function EnergyTypeDropdown({
  selectedEnergyTypes,
  onEnergyTypeChange,
}) {
  ...
  const selectedCount = selectedEnergyTypes.length;
                ...
                {ENERGY_TYPE_FILTER_OPTIONS
                  ...
                  .map((type) => (
                    <div
                      ...
                      onClick={() =>
                        onEnergyTypeChange(
                          selectedEnergyTypes.includes(type.value)
                            ? selectedEnergyTypes.filter(
                                (t) => t !== type.value
                              )
                            : [...selectedEnergyTypes, type.value]
                        )
                      }
                    >
                      <input
                        type="checkbox"
                        checked={selectedEnergyTypes.includes(type.value)}
                        readOnly
                      />
